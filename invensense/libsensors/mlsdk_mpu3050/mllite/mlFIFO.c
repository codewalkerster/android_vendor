...
inv_error_t inv_get_gyro_raw(long *data)
{
    ...
    gyro_raw[0] += (signed short)mldl_cfg->mpu_offsets->gyro[0];
    gyro_raw[1] += (signed short)mldl_cfg->mpu_offsets->gyro[1];
    gyro_raw[2] += (signed short)mldl_cfg->mpu_offsets->gyro[2];
